...
%   (c) Gabe Hoffmann, gabe.hoffmann@gmail.com extended by chaostommy
...
function save2pdf(pdfFileName,handle,dpi,fontsize,linewidth)
...
%print(handle,'-depsc',pdfFileName,sprintf('-r%d',dpi))
