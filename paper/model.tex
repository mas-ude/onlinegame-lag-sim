...
input as a stochastic process. % future work!1!!
...
screen, and larger for TV sets. \texbf{Add adaptive VSYNC?}
...
\textbf{Factors in human perception and strategy.}~The lag model 
