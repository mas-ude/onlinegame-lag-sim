...
\def\name#1{\gdef\@name{#1\\}}
\makeatother
\name{\em Albert Rafetseder$^1$, Florian Metzger$^2$, Christian Schwartz$^3$}
...
\address{$^1$Chair of Modeling of Adaptive Systems, University of Duisburg-Essen\\
  ...
  {\small \tt florian.metzger@uni-due.de, christian.schwartz@informatik.uni-wuerzburg.de} \\
  {\small \tt albert.rafetseder@univie.ac.at}
}
