...
With the help of examples of past literature we discuss the importance of the framerate and its impact on user studies. A further simulation model, putting the \gls{E2E} lag in relation to the framerate, explains the importance of such properties and their handling in objective measures.
