...
To further the understanding of the fundamental mechanisms behind \gls{E2E} lag, a simplified model and simulation was set up to investigate lag in both offline and online games, and explore its relationship with the framerate and tickrate. Figure~\ref{fig:tickrate-timeseries} shows the flow of events between game client and server for the simplified case of an online video game. % This is further elaborated in our publication in [PQS?]
Based on the model, a simulator\footnote{The repository URL with the full simulator code and data will be provided in the final version of this paper.} was created.
