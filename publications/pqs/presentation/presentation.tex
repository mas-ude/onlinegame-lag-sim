...
\begin{frame}
	...
	\begin{itemize}
		...
		\item But: past quality studies treated video games akin to video streaming:
			\pause
			\begin{itemize}
	...
	\begin{overprint}
		...
		\only<2>{
			\begin{center}
				...
				\textbf{e.g.: \SI{50}{\milli\second} less when going from $\mathbf{30}$ to $\mathbf{60}$ fps and ticks.}
			\end{center}}
		\only<3>{
			\begin{center}
