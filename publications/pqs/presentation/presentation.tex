...
\begin{frame}
	...
	\vspace{-4mm}
	\begin{itemize}
		\item Implemented as \texttt{R} simulation\only<2->{\footnote[frame]{\url{https://github.com/mas-ude/onlinegame-lag-sim}}}
	...
	\begin{overprint}
		...
		\only<2>{
			\begin{center}
				...
				\textbf{\SI{50}{\milli\second} less when going from $\mathbf{30}$ to $\mathbf{60}$.}
			\end{center}}
		\only<3>{
			\begin{center}
