...
\begin{frame}
	...
	%\begin{columns}[T]
		...
		%\column{0.5\textwidth}
		%	\vspace{2mm}
		%\movie[width=5cm, height=3cm, autostart, loop, poster]{}{extras/eli5-framerate.mov}\vspace{2mm}
		%\url{http://hugelol.com/lol/364250}
	%\end{columns}

	% create with ffmpeg:
	% ffmpeg -f gif -i framerate.gif -pix_fmt yuv420p framerate.mov
	% \begin{center}
	% 	\movie[width=5cm, height=4cm]{}{extras/framerate.mov}
	% 	\movie[width=5cm, height=4cm]{}{extras/eli5-framerate.mov}
